...
export default (onPetTypeChange) => html`
<div class="job-input">
    <div class="pet" name="pets[0]">
        ...
        <div class="field">
            ...
            <label for="pets[0][pet-type]-dog" class="field-label">
                <input type="radio" name="pets[0][pet-type]" id="pets[0][pet-type]-dog" value="dog" @change=${onPetTypeChange}/>Dog
            </label>
            <label for="pets[0][pet-type]-cat" class="field-label">
                <input type="radio" name="pets[0][pet-type]" id="pets[0][pet-type]-cat" value="cat" @change=${onPetTypeChange}/>Cat
            </label>
        </div>
        ...
        <div class="field">
            ...
            <div class="pet-related-questions">
                <div class="field">
                    ...
                    <input type="radio" name="pets[0][related-questions][is-spayed-or-neutered-$boolean]" value="true"
                        required checked> Yes
                    <input type="radio" name="pets[0][related-questions][is-spayed-or-neutered-$boolean]" value="false">
                    No
                </div>

                <div class="field">
                    <label for="pets[0][related-questions][has-chip-or-tag]">Does your pet have chip or tag?</label>
                    <input type="radio" name="pets[0][related-questions][has-chip-or-tag-$boolean]" value="true"
                        required checked> Yes
                ...
                <div class="field">
                    ...
                    <input type="radio" name="pets[0][related-questions][is-kept-at-your-address-$boolean]" value="true"
                        required checked> Yes
                    <input type="radio" name="pets[0][related-questions][is-kept-at-your-address-$boolean]" value="false">
                    No
                </div>

                <div class="field">
                    <label for="pets[0][related-questions][any-behaviour-complains]">Has your pet had any behaviour
                        complains?</label>
                    <input type="radio" name="pets[0][related-questions][any-behaviour-complains-$boolean]" value="true"
                        required checked> Yes
                    <input type="radio" name="pets[0][related-questions][any-behaviour-complains-$boolean]" value="false">
                    No
                </div>

                <div class="field">
                    <label for="pets[0][related-questions][indoor-pet]">Is your pet kept indoor?</label>
                    <input type="radio" name="pets[0][related-questions][indoor-pet-$boolean]" value="true" required
                        checked> Yes
                ...
                <div class="field">
                    ...
                    <input type="radio" name="pets[0][related-questions][is-your-pet-healthy-$boolean]" value="true"
                        required checked> Yes
                    <input type="radio" name="pets[0][related-questions][is-your-pet-healthy-$boolean]" value="false">
                    No
                </div>
            </div>
