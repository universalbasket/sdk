...
<div name="account">
    <div class="field">
        ...
        <input type="email" name="account[email]" placeholder="example@example.com" required>
    </div>

    <div class="field">
        <label class="field__name" for="account[phone]">Phone</label>
        <input type="text" name="account[phone][country-code]" value="gb" required>
        <input type="tel" name="account[phone][number]" placeholder="phone number" required>
    </div>
